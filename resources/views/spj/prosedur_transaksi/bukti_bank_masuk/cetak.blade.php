...
<head>
    <meta charset="utf-8">
    <title>Cetak Bukti Bank Masuk - A4/Custom</title>
    ...
    <style>
        ...
        /* caption / jabatan di bawah garis */
        .sign-caption {
            font-weight: 500;
            min-height: 18px;
        }
...
<body>
    ...
    <div class="page" id="receipt">
        ...
        <div class="title"><span class="title-text">BUKTI BANK MASUK</span></div>
    ...
    (function () {
        ...
        async function downloadPdfMatchingCanvas(filename = 'bukti_bank_masuk.pdf') {
