...
<head>
    <meta charset="utf-8">
    <title>Cetak Bukti Kas Keluar - A4/Custom</title>
...
<body>
    ...
    <div class="page" id="receipt">
        ...
        <div class="title"><span class="title-text">BUKTI KAS KELUAR</span></div>
    ...
    (function () {
        ...
        async function downloadPdfMatchingCanvas(filename = 'bukti_kas_keluar.pdf') {
