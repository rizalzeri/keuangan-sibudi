...
<div class="container-fluid py-3">
    <div class="d-flex align-items-center justify-content-between mb-3">
        <h4 class="mb-0">{{ $isEdit ? 'Edit Bukti Kas Keluar' : 'Buat Bukti Kas Keluar' }}</h4>
    </div>
    <div class="card shadow-sm">
        <br>

        <form id="buktiForm"
              action="{{ $isEdit ? url('/spj/bukti_kas_keluar/'.$record->id) : url('/spj/bukti_kas_keluar') }}"
            ...
            <div class="row-flex">
                ...
                <div class="input-wrap">
                    <input type="text" id="tujuan" name="tujuan" class="form-control"
                           value="{{ old('tujuan', $isEdit ? $record->tujuan : '') }}">
                </div>
            </div>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        form.addEventListener('submit', async function (e) {
            ...
            try {
                ...
                const printBase = "{{ url('/spj/bukti_kas_keluar/print') }}";
