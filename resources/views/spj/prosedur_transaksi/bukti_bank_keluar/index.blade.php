...
<div class="container-fluid py-3">
    <div class="d-flex align-items-center justify-content-between mb-3">
        <h4 class="mb-0">{{ $isEdit ? 'Edit Bukti Bank Keluar' : 'Buat Bukti Bank Keluar' }}</h4>
    </div>
    <div class="card shadow-sm">
        <br>

        <form id="buktiForm"
              action="{{ $isEdit ? url('/spj/bukti_bank_keluar/'.$record->id) : url('/spj/bukti_bank_keluar') }}"
...
<script>
    // initial values for JS (only nominal now)
